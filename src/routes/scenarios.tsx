...
function ScenariosPage() {
  ...
  return <AppShell title="Recovery plans" subtitle="Sense → Simulate → Decide → Commit">
    <div className="space-y-5 p-4 sm:p-5 lg:p-6">
      ...
      <Panel title="Plans already created" subtitle="Each result keeps its data sources, runtime provider, and safety checks">
